...
import com.tianxie.yaml.Order;
import com.tianxie.yaml.OrderLine;
...
public class YamlTest {
    ...
    @Test
    public void givenYamlInput_EventBasedProcessing() throws IOException {
        YAMLFactory factory = new YAMLFactory();
        YAMLParser parser = factory.createParser(new File("src/test/resources/yaml/orderInput.yaml"));
