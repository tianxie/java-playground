...
@Import(me.txie.springbootkafkatesting.KafkaTestContainersLiveTest.KafkaTestContainersConfiguration.class)
@SpringBootTest(classes = SpringBootKafkaTestingApplication.class)
@DirtiesContext
public class KafkaTestContainersLiveTest {
    ...
    static class KafkaTestContainersConfiguration {
        ...
        public Map<String, Object> consumerConfigs() {
            ...
            props.put(ConsumerConfig.GROUP_ID_CONFIG, "txie");
